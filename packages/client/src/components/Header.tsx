...
const views: { id: View; label: string; icon: string; key: string }[] = [
  ...
  { id: 'satnogs', label: 'NOGS', icon: '🛰️', key: '' },
  { id: 'propagation', label: 'PROP', icon: '☀', key: '' },
  { id: 'dxcluster', label: 'DX', icon: '🌍', key: '' },
  { id: 'voice', label: 'VOICE', icon: '🎙️', key: '' },
  { id: 'logbook', label: 'LOG', icon: '📓', key: '' },
  { id: 'analytics', label: 'STATS', icon: '📊', key: '' },
  { id: 'geofence', label: 'GEO', icon: '🔲', key: '' },
  { id: 'audio', label: 'AUDIO', icon: '🔊', key: '' },
  ...
  { id: 'rtl433', label: 'ISM', icon: '📡', key: '' },
  { id: 'pager', label: 'PAGER', icon: '📟', key: '' },
  { id: 'subghz', label: 'GHz', icon: '📶', key: '' },
  { id: 'sstv', label: 'SSTV', icon: '📺', key: '' },
  { id: 'meters', label: 'MTR', icon: '🔌', key: '' },
  { id: 'wifi', label: 'WiFi', icon: '📶', key: '' },
  { id: 'bluetooth', label: 'BT', icon: '🔵', key: '' },
  { id: 'tscm', label: 'TSCM', icon: '🛡️', key: '' },
  { id: 'meshtastic', label: 'MESH', icon: '📡', key: '' },
  { id: 'numberstations', label: 'SPY', icon: '🔢', key: '' },
  { id: 'fieldmode', label: 'FIELD', icon: '🏕️', key: '' },
  { id: 'vdl2', label: 'VDL2', icon: '✈️', key: '' },
  // Phase 8
  { id: 'globe', label: 'GLOBE', icon: '🌍', key: '' },
  { id: 'dsp', label: 'DSP', icon: '⚡', key: '' },
  { id: 'narrator', label: 'AI', icon: '🧠', key: '' },
  { id: 'community', label: 'HUB', icon: '🌐', key: '' },
  { id: 'academy', label: 'LEARN', icon: '🎓', key: '' },
  { id: 'history', label: 'HIST', icon: '⏳', key: '' },
  { id: 'integrations', label: 'INT', icon: '🔗', key: '' },
  { id: 'equipment', label: 'EQUIP', icon: '📡', key: '' },
  { id: 'cinematic', label: 'CINE', icon: '🎬', key: '' },
